            ...
            <form action="RecieptServlet" method="post" class="bg-white p-6 rounded-lg shadow-md" onsubmit="return validateForm();">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-5">
                  ...
                  <div>
					   ...
					   <% }else{
					    %>
					    <input type="text" name="patientid" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="latest Patient ID">
					    <% }
					    %>
				 </div>
				 <div>
